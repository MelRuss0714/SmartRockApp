$(document).ready(function () {
    ...
    $("body").on("click", ".mcs-item", function () {
        ...
        $.ajax({
            ...
            for (var i = 0; i < 5; i++) {
                console.log(resultTicketmaster[i]);
        ...
        $.ajax({
            ...
            for (var j = 0; j < 11; j++) {
                console.log(resultLastFM[j].name);
        ...
        var queryYoutube = "https://www.googleapis.com/youtube/v3/search?part=snippet&order=rating&type=video&videoDefinition=high&videoEmbeddable=" + band + "&key=AIzaSyAzeTr0uN95_jJw0El1gy6WawGeUYzm-k8"
